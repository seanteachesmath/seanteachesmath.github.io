...
A man sits down at a faculty development event *The future of AI in education*. This could be any place, at any time, hosted by anyone, in-person on Zoom, ugh, or on Teams. 
...
I have watched students hold a conversation through cells of a shared spreadsheet document, while seated just feet apart.  There is nothing wrong with that, but one of the subtle goals of this particular class was to provide practice with a variety of forms of communication.

Potential environmental impacts aside, well, maybe not just yet. To power a new data center, Microsoft made a deal to open the nuclear power plant just a few miles from where I grew up that, just a few years before I was born, experienced a partial meltdown. But, *nuclear power to keep up with AI*, is a horrifying concession.
...
Ironically, we have often limited our, and our students', available tools to decades-old technology. Suddenly, we have gone from a lifetime of use on a watch battery and solar cell, to something on the order of a half a liter of water for every 100 words of email.

We are plagued by the pursuit of innovation, when sometimes we should just stick to ["stuff that works"](<https://www.youtube.com/watch?v=2mprD2MN5vo>). Does AI have a place in higher education, sure? I just don't want to hear about it every single day.
...
The bummer is that we could do better, to be honest, many things could help with that, but, first, "people love their checkboxes" and, second, the curriculum process is painfully slow and tedious and gets in the way, sometimes for great reasons, of the need to change (umm, calculus and dynamical systems are the math of change itself).
...
Thinking *is* the fun part, right? I get that we ultimately find ourselves "checking answers" and those wind up shaping grades, but the answer is just sort of an indicator of the practice and work that came before it. If you ask most of us, it is much less important than the "work" that it is paired with. The process is so much more enjoyable, for everyone, when we are all on the same team.
